...
Let the time used when read congruent words be $\mu_C$, and the time used when read incongruent words be $\mu_I$. Our hypotheses are:
$$H_0: \mu_C-\mu_I \ge 0$$ 
$$H_a: \mu_C-\mu_I < 0 $$
The null hypothesis ($H_0$) is that the average time used when read congruent words is greater than or equal to the time used when read incongruent words. The alternative hypothesis ($H_a$) is that the average time used when read congruent words is less than the time used when read incongruent words.
